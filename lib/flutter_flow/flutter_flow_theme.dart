...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF8BC34A);
  late Color secondary = const Color(0xFFFF9800);
  late Color tertiary = const Color(0xFF03A9F4);
  late Color alternate = const Color(0xFF795548);
  ...
  late Color accent2 = const Color(0xFF673AB7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF689F38);
  late Color secondary = const Color(0xFFF57C00);
  late Color tertiary = const Color(0xFF0288D1);
  ...
  late Color accent2 = const Color(0xFF512DA8);
